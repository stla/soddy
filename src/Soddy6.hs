...
white,black,c1,c2,c3,c4,c5,c6,c7 :: Color4 GLfloat
...
display context zoom = do
  ...
  preservingMatrix $ do
    translate (toVector3 (fst interiorSphere))
    materialDiffuse Front $= c7
    renderObject Solid $ Sphere' (snd interiorSphere) 60 60
